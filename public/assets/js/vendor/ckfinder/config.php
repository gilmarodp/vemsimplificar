...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => URLPAGE . 'public/assets/js/vendor/ckfinder/userfiles/',
    'root'         => DIRPAGE . 'public/assets/js/vendor/ckfinder/userfiles/', // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
...
$config['resourceTypes'][] = array(
    ...
    'directory'         => 'public/userfiles/files',
    'maxSize'           => 0,
...
$config['resourceTypes'][] = array(
    'name'              => 'Images',
    'directory'         => 'public/userfiles/images',
    'maxSize'           => 0,
